...
function AppContent() {
  const { loading, error, metrics, derivedSorted, addTask, updateTask, deleteTask, undoDelete, lastDeleted, clearLastDeletedTask } = useTasksContext();
    ...
    <Box sx={{ minHeight: '100dvh', bgcolor: 'background.default' }}>
      <Container maxWidth="lg" sx={{ py: { xs: 3, md: 5 } }}>
        <Stack spacing={3}>
          ...
          <UndoSnackbar open={snackbarOpen} onClose={handleCloseUndo} onUndo={handleUndo} />
         </Stack>
      </Container>
    </Box>
  );
